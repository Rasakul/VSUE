...
/**
 * This class encapsulates the remote functionality for registering a user address and for looking up for the private address of a user.
 * Furthermore contains this class the opportunity to register nameservers.
 *
 * @author David Molnar
 * @since 04.01.2016
 */
public class RemoteNameserverCallback implements INameserver {
    ...
    private ConcurrentHashMap<String, INameserver> subHosts; // references to the underlying nameservers (hosted domain bzw. nameserver object)
    ...
    public void registerNameserver(String domain, INameserver nameserver, INameserverForChatserver nameserverForChatserver) throws RemoteException, AlreadyRegisteredException, InvalidDomainException {
        ...
        } else if (subHosts.keySet().contains(domainToRegister.getZone())){ // domain already registered to this nameserver
